...
public class PlaySet extends BasisActivity {
	...
	private void init() {
		...
		music_mode = (TextView) findViewById(R.id.music_mode);
		music_mode
	...
	private void initCheckBox() {
		// TODO Auto-generated method stub
		checkBox_syncho = (CheckBox) findViewById(R.id.CheckBox_auto_syncho);
		...
		checkBox_autoPlay = (CheckBox) findViewById(R.id.CheckBox_auto_play);
		...
		checkBox_autoStop = (CheckBox) findViewById(R.id.CheckBox_auto_stop);
