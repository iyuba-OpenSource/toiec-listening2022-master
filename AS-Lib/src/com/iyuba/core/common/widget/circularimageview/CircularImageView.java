...
public class CircularImageView extends androidx.appcompat.widget.AppCompatImageView {
    ...
    private void setCustomAttributes(AttributeSet attrs) {  
        ...
        mBorderThickness = a.getDimensionPixelSize(  
                R.styleable.CircularImageView_border_thickness, 0);  
        mBorderOutsideColor = a  
                .getColor(R.styleable.CircularImageView_border_outside_color,  
                        defaultColor);  
        mBorderInsideColor = a.getColor(  
                R.styleable.CircularImageView_border_inside_color, defaultColor);  
        a.recycle();
    }  
