package com.iyuba.core.common.widget.pulltorefresh;
...
public class PullToRefreshViewHeader extends LinearLayout {
	...
	public void setLastUpdated(CharSequence lastUpdated) {
		if (lastUpdated != null) {
			mHeaderUpdateTextView.setVisibility(View.VISIBLE);
			mHeaderUpdateTextView.setText(RuntimeManager
					.getString(R.string.pull_to_refresh_lastest) + lastUpdated);
		} else {
	...
	public interface OnFooterRefreshListener {
		public void onFooterRefresh(PullToRefreshViewHeader view);
	}
