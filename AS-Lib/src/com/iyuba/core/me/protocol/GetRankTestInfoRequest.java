...
//        String sign = URLEncoder.encode(uid + type + start + total + date);
        ...
        setAbsoluteURI("http://daxue."+com.iyuba.core.util.Constant.IYBHttpHead+"/ecollege/getTestRanking.jsp?uid=" +
                uid +
                "&type=" +
                type +
                "&start=" +
                ...
                "&sign=" +
                sign );
        Log.e("GetRankTestInfoRequest", "http://daxue."+com.iyuba.core.util.Constant.IYBHttpHead+"/ecollege/getTestRanking.jsp?uid=" +
                uid +
                "&type=" +
                type +
                "&start=" +
