...
public class CommentListAdapter extends BaseAdapter {
	...
	public View getView(final int position, View convertView, ViewGroup parent) {
		...
		if (String.valueOf(comment.uid) != null &&
				!"".equals(comment.uid) &&
				!String.valueOf(comment.uid).equals("0")
				&& comment.uid < 50000000) {
			viewHolder.userName.setText(comment.username);

		} else {//临时账户
			viewHolder.userName.setText(String.valueOf(comment.uid) );
		}
...
//				playVoice("http://www."+com.iyuba.core.util.Constant.IYBHttpHead+"/question/" + comment.answer);// 播放
				playVoice("http://www."+com.iyuba.core.util.Constant.IYBHttpHead+"/question/" + comment.audio);// 播放
