...
public class PrivacyDialog {
    ...
    public static void showDialog(Context context) {
        ...
        agree.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                ConfigManager.Instance().putBoolean("PrivacyDialog",false);
                dialog.dismiss();
            }
        });
    ...
    public static void goToSecret(Context context) {
        String url = WebConstant.HTTP_SPEECH_ALL +"/api/protocolpri.jsp?apptype=" + com.iyuba.configation.Constant.APPName + "&company=1";
